          ...
          <div key={index} className="group relative">
            ...
            <div className="relative bg-blue-50 dark:bg-gray-800 rounded-3xl p-6 space-y-6 transform group-hover:scale-105 transition-all duration-300">
              ...
              <div className="flex justify-center space-x-4">
                <a href="#" className="text-blue-900 dark:text-yellow-400 hover:text-yellow-400 dark:hover:text-yellow-50 transition duration-300" aria-label="LinkedIn">
                  <FaLinkedin size={24} />
                </a>
                <a href="#" className="text-blue-900 dark:text-yellow-400 hover:text-yellow-400 dark:hover:text-yellow-50 transition duration-300" aria-label="GitHub">
                  <FaGithub size={24} />
                </a>
              </div>
            </div>
